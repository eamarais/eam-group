##############################################################################################
##############################################################################################
# Fucntion to conduct reduced major axis regression (written by Eloise)
# Here I just add "r" value into the output, round the numbers and re-arrange the order of values before outputing
##############################################################################################
#!/usr/bin/python
